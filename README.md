        ...
        <div class="home">
            <div class="header">
                <header>
                    ...
                    <div class="prod">
                        <a href="product.html" title="Products" style="color: navy; text-decoration: none;"><b>Products</b></a>
                    </div>
                    <div class="people">
                        <a href="people.html" title="People" style="color:navy; text-decoration: none;"><b>People</b></a>
                    </div>
                    <div class="contact">
                        <a href="contact.html" title="Contact Us" style="color:navy; text-decoration: none;"><b>Contact Us</b></a>
                    </div>
                ...
                <div class="content">
                    <div class="text">
                    <marquee><b>Rising Software Developer</b></marquee>
                    <p style="color:rgb(255, 255, 255); font-family:'Tahoma'; font-size:20px;"> This is the Official Website of our Software company!</p>
                    </div>
                    <p>Leading software developer <span style="background-color:red; color: black;">Nizso solutions</span>
                         GST Billing software | Supermarket software | Mobile shops | Restaurent management| And much more</p>
                    <br>
                <center>
                    <img style="margin: 1cm;" src="/static/images/a.jpg">
                    <img style="margin: 1cm;" src="/static/images/b.jpg">
                    <img style="margin: 1cm;" src="/static/images/c.jpg">
                    <img style="margin: 1cm;" src="/static/images/d.jpg">    
                </center>
                
                </div>
                <div class="footer">
                <footer style="color:black">
                Copyright &copy;2023 Developed by Prasanna R</footer></div>
            </div>
        </div>
    </body>
</html>
...
<html lang="en">
    <head>
        ...
        .l3{
            color: rgb(152, 201, 229);
            position:relative;
            right:380px;
            }
        .ph4{
            background-image: url(/static/images/software.jpg);
            background-size: 300px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    ...
                    <div class="ceoph"></div>
                    <div class="ceo"><p align="center"><b><h2>Suriya R</h2></b></div>
                    <br>
                    <div class="text">
                        <p><b><u>Head executives</u></b></p><br>
                    </div>
                    <div class="manph1"></div>
                    <div class="man1"><p align="center"><b><h2>Padmashree R</h2></b></p></div>
...
.content{
    border:1px solid rgb(220, 188, 240);
    background-color: white;
    width:95%;
    height:400px;
    padding:10px;
